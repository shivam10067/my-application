...
import com.example.local1com.Model.Cart;
import com.example.local1com.Prevalent.Prevalent;
import com.example.local1com.ViewHolder.CartViewHolder;
...
public class CartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtTotalAmout=(TextView)findViewById(R.id.Total_price);

        NextProcessBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view)
            {
               // txtTotalAmout.setText("Total Price= ₹" + String.valueOf(overTotalPrice));
                                          ...
                                          cartListRef.child("User View")
                                                  ...
                                                  .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                      ...
                                                      public void onComplete(@NonNull Task<Void> task)
                                                      {
                                                            ...
                                                            {
                                                                Toast.makeText(CartActivity.this," Item removed suceesfully",Toast.LENGTH_SHORT).show();
